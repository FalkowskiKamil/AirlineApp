...
def create_map(airport_start, airport_destination=None):
    ...
    if airport_destination:
        ...
        cord_destination=(airport_destination.latitude, meridian_calculator(airport_start.longitude, airport_destination.longitude))
    ...
    if airport_destination:
        ...
        folium.Marker(
            location = [(cord_start[0] + cord_destination[0]) / 2,
...
def create_full_map(route_list):
    ...
    for route in route_list:
        ...
        destination_longitude = meridian_calculator(route.start.longitude, route.destination.longitude)
        folium.Marker(
...
def meridian_calculator(airport_start, airport_destination):
    if abs(airport_start - airport_destination) > abs(airport_start - (airport_destination-360)):
        return airport_destination-360
    elif abs(airport_start - airport_destination) > abs(airport_start - (airport_destination+360)):
        return airport_destination+360
    else:
